...
- [Особенности реализации / Implementation Details](#особенности-реализации--implementation-details)
  ...
  - [Общая схема построения и оценки признаков / General Scheme for Feature Engineering and Evaluation](#общая-схема-построения-и-оценки-признаков--general-scheme-for-feature-engineering-and-evaluation)
...
- [Примеры использования / Usage Examples](#примеры-использования--usage-examples)
  ...
  - [Агрегированный признак средней частоты / Aggregated Feature of Mean Frequency](#агрегированный-признак-средней-частоты--aggregated-feature-of-mean-frequency)
  ...
  - [Эффективная импутация пропусков / Efficient Missing Value Imputation](#эффективная-импутация-пропусков--efficient-missing-value-imputation)
...
Бинаризация существенно искажает количественную информацию: после неё нельзя утверждать что большее значение бинаризованного признака  
соответствует большему (или меньшему) исходному значению.  
...
### Общая схема построения и оценки признаков / General Scheme for Feature Engineering and Evaluation
...
<img src="images/Metrics_results.png" alt="Metrics results dataframe" width="500" />
...
### Агрегированный признак средней частоты значений / Aggregated Feature of Mean Frequency
...
### Оценка качества промежуточного датасета с помощью CatBoost / Intermediate Dataset Quality Evaluation
...
### Автоматизированный подбор гиперпараметров CatBoost с помощью Optuna / Automated Hyperparameter Tuning
...
### Эффективная импутация пропусков в больших датасетах с помощью выборочного вычисления медиан  
